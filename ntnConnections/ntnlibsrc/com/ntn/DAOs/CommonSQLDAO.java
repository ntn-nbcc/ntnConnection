 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public abstract class CommonSQLDAO {
	protected static Logger logger = Logger.getLogger(CommonSQLDAO.class);
	...
	public Connection getConnection() throws SQLException{
		if (connection == null){
			try{
			connection = ConnectionSQLBroker.getInstance().getConnection();
			}
			catch (Exception e){
